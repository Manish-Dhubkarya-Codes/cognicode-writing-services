...
export const metadata: Metadata = { title: "PhD Consultation Services | CogniCodeWrite", description: "One-on-one expert PhD consultation services. Get personalized guidance from experienced PhD holders at every stage of your doctoral journey." };
