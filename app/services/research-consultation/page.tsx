...
export const metadata: Metadata = { title: "Research Consultation | CogniCodeWrite", description: "Expert research consultation services. Strategic guidance on research design, methodology, analysis, and publication." };
