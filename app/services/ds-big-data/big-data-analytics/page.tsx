...
import { CheckCircle, Server, Zap, Database, BarChart3, Eye, GitBranch, FileText, Award, Sparkles, ZoomIn, X } from "lucide-react";
              ...
              <div>
                ...
                <div className="mt-10 flex flex-wrap gap-4">
                  <Button size="lg" asChild>
                    <Link prefetch={false} href="/contact">Start Big Data Project</Link>
                  </Button>
                  <Button size="lg" variant="outline" asChild>
                    <Link prefetch={false} href="/samples">View Big Data Samples</Link>
                  </Button>
                </div>
              </div>
                    ...
                    <div className="pl-4 grid grid-rows-[0fr] group-hover:grid-rows-[1fr] transition-[grid-template-rows] duration-500 ease-out mt-0 group-hover:mt-5">
                      ...
                      >
                        {tech.img ? (
                          ...
                          <Server className="w-full h-52 text-gray-700 opacity-50" />
                        )}
        ...
        <section className="py-20 border-t">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" asChild>
                <Link prefetch={false} href="/contact">Start Your Big Data Project</Link>
              </Button>
              <Button size="lg" variant="outline" asChild>
