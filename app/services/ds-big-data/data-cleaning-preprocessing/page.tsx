...
import { CheckCircle, Database, Zap, Layers, Eye, GitBranch, FileText, Award, Sparkles, ZoomIn, X } from "lucide-react";

const techniques = [
  {
    title: "Missing Data Handling",
    desc: "Imputation techniques, deletion strategies, and advanced methods like KNN, MICE, and deep learning-based imputation",
    img: "/data-driven-services/ds-bigdata/data-clean/missing-data-handling.png"
  },
  {
    title: "Outlier Detection & Treatment",
    desc: "Statistical, IQR, Z-score, and isolation forest methods with robust handling strategies",
    img: "/data-driven-services/ds-bigdata/data-clean/outlier-detection-treatment.png"
  },
  {
    title: "Feature Engineering & Scaling",
    desc: "Normalization, standardization, encoding (One-Hot, Label, Target), and advanced transformations",
    img: "/data-driven-services/ds-bigdata/data-clean/feature-engineering-scaling.png"
  },
  {
    title: "Automated Data Pipelines",
    desc: "End-to-end preprocessing pipelines using scikit-learn, Pandas, and PySpark for scalable, reproducible workflows",
    img: "/data-driven-services/ds-bigdata/data-clean/automated-data-pipelines.png"
  }
];
...
export default function DataCleaningPreprocessingPage() {
  ...
  // Lightweight & reliable scroll lock
  useEffect(() => {
              ...
              <div>
                ...
                <div className="mt-10 flex flex-wrap gap-4">
                  <Button size="lg" asChild>
                    <Link prefetch={false} href="/contact">Start Data Cleaning Project</Link>
                  </Button>
                  <Button size="lg" variant="outline" asChild>
                    <Link prefetch={false} href="/samples">View Cleaning Samples</Link>
                  </Button>
                </div>
              </div>

              <div className="relative">
                <Card className="bg-gradient-to-br from-orange-600 to-amber-600 text-white shadow-2xl border-0 overflow-hidden">
        ...
        <section className="py-16 md:py-24">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="font-serif text-4xl font-bold">Data Cleaning &amp; Preprocessing Services We Provide</h2>
              <p className="mt-3 text-muted-foreground">From basic cleaning to advanced automated pipelines using Pandas, PySpark &amp; scikit-learn</p>
            </div>
                    ...
                    <div className="pl-4 grid grid-rows-[0fr] group-hover:grid-rows-[1fr] transition-[grid-template-rows] duration-500 ease-out mt-0 group-hover:mt-5">
                      ...
                      >
                        {tech.img ? (
                          ...
                          <Database className="w-full h-52 text-gray-700 opacity-50" />
                        )}
        ...
        <section className="py-20 border-t">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" asChild>
                <Link prefetch={false} href="/contact">Start Your Data Cleaning Project</Link>
              </Button>
              <Button size="lg" variant="outline" asChild>
