...
import { CheckCircle, Monitor, BarChart3, Palette, Eye, GitBranch, FileText, Award, ZoomIn, X } from "lucide-react";
                    ...
                    <div className="pl-4 grid grid-rows-[0fr] group-hover:grid-rows-[1fr] transition-[grid-template-rows] duration-500 ease-out mt-0 group-hover:mt-5">
                      ...
                      >
                        {tech.img ? (
                          ...
                          <Monitor className="w-full h-52 text-gray-700 opacity-50" />
                        )}
