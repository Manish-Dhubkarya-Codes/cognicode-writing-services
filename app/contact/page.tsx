...
const contactInfo = [
  {
    name: "Email",
    value: "support@cognicodewrite.com",
    icon: Mail,
  ...
  {
    name: "Office",
    value: "123 Academic Drive, Suite 100, Boston, MA 02101",
    icon: MapPin,
...
export default function ContactPage() {
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-background/70">
                ...
                with our team. We're here to help you succeed in your academic
                journey.
              </p>
            </div>
          </div>
  ...
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div className="aspect-[21/9] rounded-2xl overflow-hidden">
      <iframe
        src="https://www.google.com/maps?q=CogniCode+India&output=embed"
        width="100%"
        height="100%"
        style={{ border: 0 }}
        loading="lazy"
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <div className="mt-10 flex items-center justify-center gap-4 flex-wrap">
                ...
                >
                  <a
                    href="mailto:support@cognicodewrite.com"
